...
#define MOTOR_BASE_MAX_SPEED 800
#define MOTOR_BASE_ACCELERATION 20
...
#define MOTOR_ROTADOR_MAX_SPEED 800
#define MOTOR_ROTADOR_ACCELERATION 20
...
#define SERVO_ELEVACION_BRAZO_PIN 47
